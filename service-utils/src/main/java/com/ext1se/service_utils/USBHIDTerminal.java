...
import com.ext1se.service_utils.core.services.SocketService;
import com.ext1se.service_utils.core.services.USBHIDService;
import com.ext1se.service_utils.core.services.WebServerService;
...
public class USBHIDTerminal extends Activity implements View.OnClickListener {
	...
	public void onEvent(USBDataReceiveEvent event) {
		count++;
		Log.d("USB_DataReceive","Received USBHIDTerminal: " + event.getBytesCount());
		mLog(event.getData() + " \nReceived " + event.getBytesCount() + " bytes; Count = " + count, true);
	}
