            ...
            if (ACTION_USB_PERMISSION.equals(action))
            {
                synchronized (this)
                {
                    ...
                    if (intent.getBooleanExtra(UsbManager.EXTRA_PERMISSION_GRANTED, false))
                    {
                        ...
                        else Log.e("TAG", "ACTION_USB_PERMISSION VIVE Dongle device is not exist!");
                    }
                    else {
            ...
            else if (ACTION_USB_DEVICE_ATTACHED.equals(action))
            {
                synchronized (this)
                {
                    ...
                    if (intent.getBooleanExtra(UsbManager.EXTRA_PERMISSION_GRANTED, false))
                    {
                        ...
                        else Log.e("TAG", "ACTION_USB_DEVICE_ATTACHED VIVE Dongle device is not exist!");
                    }
                    else {
                        ...
                        if(_device != null)
                        {
                            ...
                            else Log.e("TAG", "ACTION_USB_DEVICE_ATTACHED VID and PID device is not equal VIVE");
                        }
            ...
            else if (ACTION_USB_DEVICE_DETACHED.equals(action))
            {
                synchronized (this)
                {
                    ...
                    if (intent.getBooleanExtra(UsbManager.EXTRA_PERMISSION_GRANTED, false))
                    {
                        ...
                        else Log.e("TAG", "ACTION_USB_DEVICE_DETACHED VIVE Dongle device is not exist!");
                    }
                    else {
